...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"BirdsAroundMe" withExtension:@"momd"];
...
//    }
//    
//    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BirdsAroundMe.sqlite"];
//    
//    NSError *error = nil;
